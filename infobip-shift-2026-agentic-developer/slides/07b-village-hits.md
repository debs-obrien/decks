...
<span class="badge badge-green" style="font-size:14px;padding:5px 14px;margin-bottom:8px">village hits</span>

<h2 style="font-size:36px;margin-bottom:4px">What the bots already do</h2>
<p class="lede" style="margin-bottom:8px">Real moments. Not a feature list.</p>

<div class="card-stack" style="margin-top:0;max-width:1040px;gap:8px">
...
<!--
PRESENTER NOTES: VILLAGE HITS
- Flash three beats. Don't rebuild each story.
- Point: life bots already ship. Then we go deep on swim.
-->
