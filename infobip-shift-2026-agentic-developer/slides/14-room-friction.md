...
<div class="card-row" style="max-width:920px;margin:0 auto">
  <div class="task-card" style="border-color:var(--red)">
    ...
    <p>Agents must not hallucinate hotel codes.</p>
  </div>
  <div class="task-card" style="border-color:var(--accent)">
    <span class="task-id" style="color:var(--accent)">Do</span>
    <h3>Ask via CoS</h3>
    <p>I unblock with room <span class="mono">00</span>. Known placeholder.</p>
  </div>
</div>
...
<!--
PRESENTER NOTES: ROOM FRICTION
- Say room 00 only. Never street / phone / email.
- Same rule later at PayPal: consequential steps stay human.
-->
